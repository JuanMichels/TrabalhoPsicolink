...
uses
  ...
  Data.DB, Vcl.Grids, Vcl.DBGrids, UnDMAgenda, Vcl.Buttons, Vcl.StdCtrls,
  UnGridPaciente, UnDMPrincipal, UnProntuárioPaciente, Vcl.Mask, Vcl.DBCtrls;
...
type
  ...
  public
    ...
    // property AgendaID: Integer read FAgendaID write FAgendaID;
    PacienteID: Integer;
    AgendaID: Integer;
  end;
